...
export default {
  ...
  // FooterTab
  tabBarTextColor: "#A7A9AC",
  tabBarTextSize: 11,
  activeTab: "#fff",
  sTabBarActiveTextColor: "#f7941d",
  tabBarActiveTextColor: "#f7941d",
  tabActiveBgColor: "#ffffff",

  // Header
  toolbarBtnColor: "#fff",
  toolbarDefaultBg: platform === "ios" ? "#f7941d" : "#f7941d",
  toolbarHeight: 48,
  ...
  // Radio Button
  radioBtnSize: 23,
  radioSelectedColorAndroid: "#f7941d",
  ...
  // Tab
  tabDefaultBg: "#fff",
  topTabBarTextColor: "#a7a9ac",
  topTabBarActiveTextColor: "#000",
  topTabBarBorderColor: "#d8d8d8",
  topTabBarActiveBorderColor: "#f7941d",
